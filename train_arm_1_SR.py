...
num_episodes = 100
max_step = 70
env.time_limit = max_step #default 200
epsilon =0
batch_size = 5
...
with tf.Session() as sess:
    ...
    for episode in range(num_episodes):
        ...
        while (not done) and steps<max_step:
            ...
            #NOTE: epsilon is an exploitation vs exploration param. in beginning, epsilon is small so therefore more random actions are taken, ie exploration. later on, epsilon big so actions based on trained policy, ie exploitaiton.
            ...
            #NOTE: windowing for policy update with batch_size. so that aren't super reactionary to single steps. not in original tutorial
